  ...
  return (
    <>
      ...
      <aside
        ...
        className={`border-4 bg-white border-red-500 border-rose-700 fixed z-50 top-[var(--header-height)] w-80 right-0 ${translate}  transition-transform duration-300 ease-in-out lg:translate-x-0`}
      >
        <div className="p-5">
